...
int CPortmapProg::Process(IInputStream* pInStream,
                          IOutputStream* pOutStream,
                          ProcessParam* pParam) {
  static PPROC pf[] = {&CPortmapProg::ProcedureNULL,
                       &CPortmapProg::ProcedureSET,
                       &CPortmapProg::ProcedureUNSET,
                       &CPortmapProg::ProcedureGETPORT,
                       &CPortmapProg::ProcedureDUMP,
                       &CPortmapProg::ProcedureCALLIT};
...
void CPortmapProg::Write(unsigned long prog,
                         unsigned long vers,
                         unsigned long proto,
                         unsigned long port) {
